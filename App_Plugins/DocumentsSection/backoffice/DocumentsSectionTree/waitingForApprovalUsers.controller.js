angular.module("umbraco").controller("RequestedUserList.WaitingForApprovalUsersController",
    function ($scope, $routeParams, RequestedUserListResource, notificationsService, navigationService) {
        ...
        RequestedUserListResource.getUsersList("waitingForApprovalUsers").then(function (response) {
