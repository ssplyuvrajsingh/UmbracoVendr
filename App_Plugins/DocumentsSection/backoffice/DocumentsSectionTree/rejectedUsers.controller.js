angular.module("umbraco").controller("RequestedUserList.RejectedUsersController",
    function ($scope, $routeParams, RequestedUserListResource, notificationsService, navigationService) {
        ...
        RequestedUserListResource.getUsersList("rejectedUsers").then(function (response) {
